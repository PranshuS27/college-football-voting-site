// Utility to extract conference names and teams from seed_teams.py
// Used for frontend tab to pick conference champions

export const conferences = [
  {
    name: "SEC",
    teams: ["Alabama", "Arkansas", "Auburn", "Florida", "Georgia", "Kentucky", "LSU", "Mississippi State", "Missouri", "Ole Miss", "South Carolina", "Tennessee", "Texas", "Oklahoma", "Texas A&M", "Vanderbilt"]
  },
  {
    name: "Big Ten",
  ...
  {
    name: "ACC",
    teams: ["Boston College", "California", "Clemson", "Duke", "Florida State", "Georgia Tech", "Louisville", "Miami", "North Carolina", "North Carolina State", "Pittsburgh", "SMU", "Stanford", "Syracuse", "Virginia", "Virginia Tech", "Wake Forest"]
  },
  {
    name: "Big 12",
  ...
  {
    name: "Conference USA",
    teams: ["Delaware", "FIU", "Jacksonville State", "Kennesaw State", "Liberty", "Louisiana Tech", "Middle Tennessee", "Missouri State", "New Mexico State", "Sam Houston", "UTEP", "Western Kentucky"]
  },
  {
    name: "MAC",
